...
public class DoctorsProfile implements Parcelable {
    ...
    public String getHasTelemedicine() {
        return HasTelemedicine;
    }

    public void setHasTelemedicine(String hasTelemedicine) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(HasTelemedicine);
