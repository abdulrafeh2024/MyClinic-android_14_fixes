...
public class InsuranceModel implements Parcelable {
    ...
    protected InsuranceModel(Parcel in) {
    ...
    public static final Creator<InsuranceModel> CREATOR = new Creator<InsuranceModel>() {
        @Override
