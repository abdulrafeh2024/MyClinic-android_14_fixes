...
/**
 * Created by Asad Abbas on 4/23/19.
 * Copyrights © 4/23/19 Ammad Ali. All rights reserved
 */
...
public class TinyDB {
    ...
    public ArrayList<Company> getListCompany(String key) {
        Gson gson = new Gson();
        ...
        for (String jObjString : objStrings) {
            Company value = gson.fromJson(jObjString, Company.class);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<ApptsMiniModel> getListAppointment(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ApptsMiniModel> objects = new ArrayList<ApptsMiniModel>();

        for (String jObjString : objStrings) {
            ApptsMiniModel value = gson.fromJson(jObjString, ApptsMiniModel.class);
            objects.add(value);
        }
        return objects;
    }
...
//
    ...
    public void putListCompany(String key, ArrayList<Company> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (Company obj : objArray) {
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }

    public void putListAppointments(String key, ArrayList<ApptsMiniModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ApptsMiniModel obj : objArray) {
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
