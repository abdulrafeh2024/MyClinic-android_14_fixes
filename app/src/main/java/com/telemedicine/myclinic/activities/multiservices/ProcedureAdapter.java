...
public class ProcedureAdapter extends RecyclerView.Adapter<ProcedureAdapter.MyViewHolder> {
    ...
    public ProcedureAdapter(Activity c, ArrayList<ServiceItems> list) {
        this.list = list;
        mC = c;
    }

    @Override
    public ProcedureAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.med_list_item, parent, false);

        return new ProcedureAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ProcedureAdapter.MyViewHolder holder, final int position) {
