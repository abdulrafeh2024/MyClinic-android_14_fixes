...
public class AdapterDashboardUpcomingAppointments extends RecyclerView.Adapter<AdapterDashboardUpcomingAppointments.MyViewHolder> {

    ArrayList<ApptsMiniModel> list;
    Activity mC;
    AdapterUpcomingAppointments.OnCardClickListner onCardClickListner;
    TimeAgoMessages messages = null;

    public AdapterDashboardUpcomingAppointments(Activity c, ArrayList<ApptsMiniModel> list) {
        this.list = list;
        mC = c;
    ...
    @Override
    public AdapterDashboardUpcomingAppointments.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = null;

        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_home_upcoming_appointment_view, parent, false);
     /*   if (TextUtil.getEnglish(mC)) {
        ...
        return new AdapterDashboardUpcomingAppointments.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final AdapterDashboardUpcomingAppointments.MyViewHolder holder, final int position) {
            ...
            if (doctorsProfile != null) {
             ...
             /*   if (list.get(position).getApptBookType() == 10) {
                ...
                if (!ValidationHelper.isNullOrEmpty(dateTime)) {
                    ...
                    String date = LocaleDateHelper.convertDateStringFormat(dateTime, "yyyy-MM-dd'T'HH:mm:ss", "dd/MM/YYYY hh:mm a");
...
*/
    ...
    public void setOnCardClickListner(AdapterUpcomingAppointments.OnCardClickListner onCardClickListner) {
